      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light position-relative">
        <NavLink className="navbar-brand" to="/">
          <img
            ...
            src={
              "https://cdn.dribbble.com/userupload/3232136/file/original-0fd4209ff091851842570400d634352b.png?compress=1&resize=50x50"
            }
          ></img>
        </NavLink>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto ">
            ...
            <li className="nav-item ">
              <NavLink className="nav-NavLink" to="/addnote">
                AddNote
              </NavLink>
            </li>
